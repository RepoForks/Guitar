...
/**
 * Created by William on 12/24/2015.
 */
public class DisplaySongsActivity extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemClickListener {
    ...
    private void init() {
        ...
        mAdapterListFile = new SongListAdapter(DisplaySongsActivity.this, mSongList);
